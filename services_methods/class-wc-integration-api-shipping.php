...
use IntegrationAPI\Services\CalculateShippingMethodService;
use IntegrationAPI\Helpers\MoneyHelper;

/**
 * Default SuperFrete shipping method abstract class.
 *
 * This is a abstract method with default options for all methods.
 */

if ( class_exists( 'WC_Shipping_Method' ) ) {
	abstract class WC_Integration_API_Shipping extends WC_Shipping_Method {
		...
		/**
		 * Initialize the SuperFrete shipping method.
		 *
		...
		public function __construct( $instance_id = 0 ) {
			...
			$this->method_description = sprintf( 'Metódo de envio %s do SuperFrete', $this->method_title );
			...
			add_action(
				'woocommerce_sf_update_options_shipping_' . $this->id,
