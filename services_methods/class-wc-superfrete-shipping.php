...
use Superfrete\Services\CalculateShippingMethodService;
...
if ( class_exists( 'WC_Shipping_Method' ) ) {
	abstract class WC_Superfrete_Shipping extends WC_Shipping_Method {
		...
		public function __construct( $instance_id = 0 ) {
			...
			add_action(
				'woocommerce_superfrete_update_options_shipping_' . $this->id,
